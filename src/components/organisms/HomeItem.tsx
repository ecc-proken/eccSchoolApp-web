...
const HomeItem: VFC<Props> = ({ icon, title, path, children }) => {
  return (
    ...
    >
      <span className='block p-3 text-blue-500 bg-blue-100 rounded-full'>
      ...
      <div className='ml-auto pr-4 w-fit -mx-1 text-sm text-blue-500 capitalize transition-colors duration-200 transform hover:underline hover:text-blue-600'>
